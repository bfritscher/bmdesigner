<template>
    <div>
        <div>
            <v-btn @click.native="playGame('nespresso')">Nespresso</v-btn>
            <v-btn @click.native="playGame('uber')">Uber</v-btn>
            <v-btn @click.native="playGame('airbnb')">Airbnb</v-btn>
            <v-btn @click.native="playGame('apple')">Apple</v-btn>
        </div>
